...
export const getUserRating = async (propertyInput, userData) => {
  ...
  And then other keys of location, facilities and sustainability with ratings out of 5 that helped get the overall rating. The overall rating must
  reflect the information I have given you. Note that I only want ratings in increments of 0.5`;
